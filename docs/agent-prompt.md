...
6. When the phase is `face`, ask them to look at the camera and smile as wide as they can. Call `start_face_test` and wait for its result before speaking again.
