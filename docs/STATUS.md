...
| Voice agent (ElevenLabs) | open | done | Integration completed with API keys. |
...
- 2026-09-19 — voice agent — implemented client tools (`start_face/arm_test`, etc.), `useAgent` hook, backend signed-url endpoint; ElevenLabs integration is stubbed out waiting for API keys.
