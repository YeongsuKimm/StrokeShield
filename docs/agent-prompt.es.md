...
7. Cuando la fase sea `arms`, pídale que siga alejándose hasta que se vean las dos manos (no mencione una distancia: depende de su cámara, y un teléfono en vertical necesita unos dos metros). Llame a `start_arm_test` y espere su resultado antes de volver a hablar.
