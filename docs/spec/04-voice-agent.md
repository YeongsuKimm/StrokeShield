...
5. Arms (patient steps back): "Keep stepping back until I can see both of your hands." (no distance: a phone in portrait needs ~6 ft, a laptop far less) → `start_arm_test` (tool result says when they're in position). Then: "Hold both arms straight out to your sides, palms up, for ten seconds."
