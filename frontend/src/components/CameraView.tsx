      ...
      >
        ...
        {progress?.phase === 'intro' && progress.caption && (
          <div className="absolute inset-0 flex items-center justify-center p-4">
            ...
            >
              <p className="text-balance text-xl font-semibold leading-snug sm:text-2xl">{smartQuotes(progress.caption)}</p>
              <p className="mt-2 text-[0.9375rem] font-medium text-white/85">Starting in {progress.secondsLeft}…</p>
            </div>
          </div>
        )}
