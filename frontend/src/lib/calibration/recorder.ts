...
import { findScenario, recordingFileName, scenariosFor, serializeRecording, type Recording, type RecordingInputs, type RecordingKind } from './recording'
 ...
 * break a real test run) and does nothing unless `?record=1`.
 */
export function recordRun(inputs: RecordingInputs, liveResult: TestResult): void {
